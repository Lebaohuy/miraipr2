...
module.exports.config = {
    ...
    envConfig: {
        APIKEY: "MEWbmd1eWVuZHV5bGFtO2R1eWxhbTIwMDIubmRAZ21haWwuY29t"
    }
}
...
async function simsimi(a, b, c) {
    ...
    try {
        var { data: j } = await d({ url: `https://meewmeew.info/simsimi/api?ask=hello&apikey=MEWbmd1eWVuZHV5bGFtO2R1eWxhbTIwMDIubmRAZ21haWwuY29t}`, method: "GET" });
